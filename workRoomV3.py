...
NowLocation = imports.workRoomV3_scaled
NowLocationRect = imports.workRoomV3_scaled_rect
...
dialog_window = [
    dialogs.dialog(params.WIDTH / (1920 / 1300), params.HEIGHT / (1080 / 300), params.WIDTH / (1920 / 450),params.HEIGHT / (1080 / 650), imports.workRoomDialogV3)
]

newXPos = params.WIDTH / (1920 / 437)
newYPos = params.HEIGHT / (1080 / 320)