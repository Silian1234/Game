...
walls = [
    ...
    Block.Block(params.WIDTH / (1920 / 10), params.HEIGHT / (1080 / 650), params.WIDTH / (1920 / 1730), params.HEIGHT / (1080 / 400)),
...
activator = [
    Activator.Activator(params.WIDTH / (1920 / 369), params.HEIGHT / (1080 / 363), params.WIDTH / (1920 / 723), params.HEIGHT / (1080 / 587))
]
...
dialog_window = [
    dialogs.dialog(params.WIDTH / (1920 / 1300), params.HEIGHT / (1080 / 300), params.WIDTH / (1920 / 450), params.HEIGHT / (1080 / 650), imports.thirdDialog)
]

newXPos = params.WIDTH / (1920 / 1210)
newYPos = params.HEIGHT / (1080 / 690)