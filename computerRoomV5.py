...
NowLocation = imports.computerRoomV5_scaled
NowLocationRect = imports.computerRoomV5_scaled_rect
...
activator = [
    Activator.Activator(params.WIDTH / (1920 / 250), params.HEIGHT / (1080 / 115), params.WIDTH / (1920 / 1177), params.HEIGHT / (1080 / 253))
]
...
newXPos = params.WIDTH / (1920 / 1650)
newYPos = params.HEIGHT / (1080 / 340)