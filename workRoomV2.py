...
dialog_window = [
    dialogs.dialog(params.WIDTH / (1920 / 1300), params.HEIGHT / (1080 / 300), params.WIDTH / (1920 / 450),params.HEIGHT / (1080 / 650), imports.workRoomV2Dialog)
]

newXPos = params.WIDTH / (1920 / 450)
newYPos = params.HEIGHT / (1080 / 440)